...
import platform
import copy
from dronesdk import APIException
...
class MAVConnection(object):
    ...
    def __init__(
        ...
        # keep it private, expose something smaller for dronesdk
        ...
        def callback(_, msg):
            try:
                ...
                try:
                    ...
                    self._logger.exception(
                        "Could not pack this object on receive: %s" % type(msg),
                        exc_info=True,
                    )
        ...
        def callback(_, msg):
            ...
            try:
                ...
                try:
                    ...
                    self._logger.exception(
                        "Could not pack this object on forward: %s" % type(msg),
                        exc_info=True,
                    )
