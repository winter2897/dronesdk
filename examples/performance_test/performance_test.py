...
parser = argparse.ArgumentParser(
    description="Generates max, min and current interval between message sent and ack recieved. Will start and connect to SITL if no connection string specified."
)
parser.add_argument(
    "--connect",
