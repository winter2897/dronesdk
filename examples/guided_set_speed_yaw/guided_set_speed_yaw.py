...
from dronesdk import connect, VehicleMode, LocationGlobal, LocationGlobalRelative
...
def goto(dNorth, dEast, gotoFunction=vehicle.simple_goto):
    ...
    The method takes a function pointer argument with a single `dronesdk.lib.LocationGlobal` parameter for
    the target position. This allows it to be called with different position-setting commands.
    By default it uses the standard method: dronesdk.lib.Vehicle.simple_goto().
...
# This reloads the home location in dronesdk and GCSs
